...
- Linear Gated DeltaNet sequence math has recurrent state coverage for bounded prefill and a cache-backed `LinearAttentionCache` path, but native Qwen decode is not wired to use it incrementally yet.
